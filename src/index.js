...
async function pushRecommendedSitesToTargets(env){
  const target={id:0,name:'跑狗论坛',receiver_url:'https://txpglt.q3665.com/recommended-sites-sync.php',sync_token:'001e7955b0f881ebd5d6752f837a0eb232408232ef80152f'},payload=await makeRecommendedSitesSyncPayload(env);
