...
(function(){
  const types=[1,5,8],link='https://6hgs01z.duoldq.com/promo-login/?channelCode=883',esc=value=>String(value??'').replace(/[&<>"']/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c]));
  ...
  apply(type());document.querySelectorAll('#lotteryMenu button,.lottery-tab').forEach(button=>button.addEventListener('click',()=>setTimeout(()=>apply(type()),0)));
})();
